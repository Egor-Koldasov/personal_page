...
export const CardBox = ({ portfolioItem, activeItem, setActiveItem }: CardBoxProps) => {
  ...
  return (
    <CardBoxStyled
      ...
      onClick={onClick}
    >
      <CardItem className="overlay" portfolioItem={portfolioItem} onClose={onClose} active={active} />
