...
const ThemeSwitch = (props: ThemeSwitchProps) => {
  return (
    ...
    >
      <span className="dark"><Image layout="fixed" width={32} height={32} src="/icons/sun.png" alt="" /></span>
      <span className="light"><Image layout="fixed" width={32} height={32} src="/icons/moon.png" alt="" /></span>
      {/* {props.nextTheme} */}
    </ThemeSwitchStyled>
  )
}
