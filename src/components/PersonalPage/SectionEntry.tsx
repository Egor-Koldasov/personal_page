...
import { bgBlack, textCyan, textGreen, textYellow } from '../../styles/modules/colors';
...
const NameTitle = styled.h1`
  color: ${themeProp('sectionEntry.nameTextColor')};
  text-align: center;
  font-size: 2.3rem;
  line-height: 2rem;
  font-weight: bold;
...
const WebDevTitle = styled.h3`
  color: ${themeProp('sectionEntry.webDevTitleColor')};
  font-size: 2.3rem;
  line-height: 2rem;
  background-color: ${themeProp('sectionEntry.webDevTitleBg')};
  padding: 1rem;
  border: .4rem solid ${themeProp('sectionEntry.webDevBorderColor')};
...
const StackTitle = styled.h1`
  color: ${themeProp('sectionEntry.stackColor')};
  text-align: center;
  font-size: 1.5rem;
  font-weight: bold;
`
const Section1Styled = styled(BaseSection)`
  background-color: ${themeProp('sectionEntry.mainBg')};
`;
